...
$connection <DO> <AMOUNT> <INPUT>
    ...
    if adding multiple connections:
...
$generaterandom <TYPE> <#>
    Replace <#> with the number of random connections you want to
    generate.
...
1. Start adding connections, either one at a time
    using:
        $connection add singular <INPUT>

    or multiple at once using:
        $connection add multiple <INPUT>
